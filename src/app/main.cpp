...
{
  // prepare input
  cv::Mat img_raw = cv::imread("/home/gitspace/DLDataProcess/src/test/test.jpg");
  cv::resize(img_raw,img_raw,cv::Size(800,800));

  //实例化ImageWarpaffine
  std::string config_path = "/home/gitspace/DLDataProcess/src/config/DataProcess.yaml";
  ...
  cv::imwrite("/home/gitspace/DLDataProcess/src/test/After_WarpAffine.jpg", output);
  std::cout << "Save After_WarpAffine.jpg." << std::endl;

  // ll_seg_filter测试
  cv::Mat ll_seg_mask = cv::imread("/home/gitspace/DLDataProcess/src/test/ll_mask.bmp",
  ...
  cv::imwrite("/home/gitspace/DLDataProcess/src/test/ll_seg_filter.jpg", draw_ll);
  std::cout << "Save ll_seg_filter.jpg." << std::endl;

  // da_seg_filter测试
  cv::Mat da_seg_mask = cv::imread("/home/gitspace/DLDataProcess/src/test/da_mask.bmp",
                                   0);  // bmp文件不会损失精度，这里需要读入灰度图
  ...
  cv::imwrite("/home/gitspace/DLDataProcess/src/test/da_seg_filter.jpg", draw_da);
